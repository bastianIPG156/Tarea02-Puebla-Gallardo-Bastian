...
def parse_args_argparse():
    parser = argparse.ArgumentParser(description="Consulta el fabricante de una tarjeta de red por su direccion IP o MAC.")
    parser.add_argument("-i", "--ip", type=str, help="Direccion IP del host a consultar.")
...
def main():
    ...
    if ip:
        ...
        if mac_address:
            ...
            print(f"\nError: IP esta fuera de la red del host.\n")
        ...
        print("Por favor, proporciona una opcion valida (-i, -m o -a).")
